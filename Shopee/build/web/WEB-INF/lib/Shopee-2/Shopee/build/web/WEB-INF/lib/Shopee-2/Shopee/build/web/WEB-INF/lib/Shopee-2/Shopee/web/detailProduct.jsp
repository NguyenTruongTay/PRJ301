        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4">
                    <h5>Preferential service</h5>

                        <br>Free ship everywhere

                        <br>From only 2k/day, get a 1-for-1-in-one-year Warranty Package

                        <br>0% Apple Installment via Shinhan SVFC

                        <br>Get 200,000 VND when you buy JBL Charge 4 Bluetooth Speaker</p>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            ...
                            <p>Is the version officially distributed by Vietnam electronics company, 
                                is warranted for 12 months at the most senior Authorized Center in Vietnam and globally for free. 
                                Order products at Mobile Viet to be able to own the device as soon as possible with many incentives and promotions included.</p>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item px-0">
                                            Free up to 1,000,000 VND when the old collection is renewed
                                        </li>
                                        <li class="list-group-item px-0">
                                            Discount 1,000,000 VND when paying and paying via ABC
                                        </li>
                                        <li class="list-group-item px-0">
                                            Instant discount of 200,000 VND when buying genuine accessories
                                        </li>
                                        <li class="list-group-item px-0">
                                            0% Installment via Shinsha Finance House
                                        </li>
                                    </ul> 
                                </div>
